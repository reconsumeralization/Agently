 ...
 'companions': {'devtools': {'companion_package': 'agently-devtools',
                ...
                'blocks': {'lifecycle_contract': 'Blocks is the internal lowering bridge from AgentTaskLoop '
                           ...
                           'agent_task_loop_contract': 'AgentTaskLoop bounded execution steps run through '
                                                       ...
                                                       'lower as agent_step blocks. TaskDAG is no longer an '
                ...
                'action_runtime': {'action_statuses': ['success',
                                   ...
                                   'action_evidence_refs_contract': 'Instruction-heavy or large Action records use '
                                                                    ...
                                                                    'surfaced on ActionResult/model_digest. When a '
                                                                    'digest is still too large for later planning or '
                                                                    'reply hot paths, ActionRuntime compacts the '
                                                                    'model-visible digest again, replaces duplicate '
                                                                    'data/model_digest fields with same_as=result '
                                                                    'pointers, omits artifact preview bodies from '
                                                                    'hot-path artifact_refs, and keeps '
                                                                    'read_action_artifact available for explicit '
                                                                    'scoped readback. '
 ...
 'request_input': {'agent_execution_request_scope': {'status': 'released',
                   ...
                   'agent_execution_task_loop': {'status': 'released',
                                                 ...
                                                 'contract': 'The 4.1.3.7 task-loop contract remains the published '
                                                             ...
                                                             'progress, and reflection_density; effort budget values '
                                                             'such as iteration_limit, model_call_limit, and '
                                                             'wall_time_seconds are soft strategy metadata for '
                                                             'planning complexity, reflection density, repair posture, '
                                                             'and evidence depth, and do not silently set task-loop '
                                                             'max_iterations or AgentExecution hard limits. Hosts that '
                                                             'need hard resource controls must use explicit task '
                                                             'options or limits={...}. By default, AgentTask does not '
                                                             'impose model-request, iteration, TaskBoard tick, or '
                                                             'Action round quotas; no-progress and idle timeouts '
                                                             'remain liveness guards for stuck executions, not '
                                                             'strategy evidence. effort reflection_density maps '
                                                             'low to final '
                                                             ...
                                                             'explicitly configured max_iterations can return accepted=false and '
