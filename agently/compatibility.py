 ...
 'companions': {'devtools': {'companion_package': 'agently-devtools',
                ...
                'blocks': {'lifecycle_contract': 'Blocks is the internal lowering bridge from AgentTaskLoop '
                           ...
                           'agent_task_loop_contract': 'AgentTaskLoop bounded execution steps run through '
                                                       ...
                                                       'dependency state, patch validation, and finalization. Flat '
                                                       ...
                                                       'propose query groups; Flat BlockCarrier lowers those query '
                                                       'groups into pre-step Blocks workspace_operation.search facts '
                                                       'and injects scoped_retrieval_results into the downstream '
                                                       'bounded agent_step; Workspace search_files and Blocks '
                                                       'workspace_operation return factual '
                                                       'locator_ref/evidence_snippet records only, and Workspace '
                                                       'search accepts structural collection/kind/id/path/scope/meta '
                                                       'filters for scoped retrieval. TaskBoard readback '
                                                       ...
                                                       'generated continuation cards. TaskDAG is no longer an '
