...
_CURRENT_RELEASE_MANIFEST: dict[str, Any] = {'schema_version': 1,
 ...
 'request_input': {'agent_execution_plugins_and_terminal_policies': {'surface': ['Agent.create_execution',
                                                                     ...
                                                                     'producer_contract': 'Built-ins share the '
                                                                                          ...
                                                                                          'before dispatch. Plan and '
                                                                                          'long_content reject '
                                                                                          'ensure_long_output mixing; '
                                                                                          'long_content rejects '
                                                                                          'structured output. '
                                                                                          'Disconnected plan '
                                                                     ...
                                                                     'typing_contract': 'Ordinary fluent calls retain '
                                                                                        ...
                                                                                        'owning namespaces.',
                                                                     'pending_control_contract': 'Unified '
                                                                                                 'rework/interrupt/pause/resume/save/load '
                                                                                                 'capability and '
                                                                                                 'revision contracts '
                                                                                                 'are not yet '
                                                                                                 'implemented by this '
