...
_CURRENT_RELEASE_MANIFEST: dict[str, Any] = {'schema_version': 1,
 ...
 'companions': {'devtools': {'companion_package': 'agently-devtools',
                ...
                'blocks': {'lifecycle_contract': 'Blocks is the internal lowering bridge from AgentTaskLoop '
                           ...
                           'runtime_contract': 'ExecutionBlock is trusted runtime code lowered to one TriggerFlow '
                                               ...
                                               'supports bounded Workspace SQLite/FTS search and read_bounded facts, '
                                               'and separates locator_ref from evidence_snippet without judging '
                                               'semantic usefulness; approval_wait records waiting evidence while '
                                               'using PolicyApproval and TriggerFlow pause/resume; external_wait '
                                               'records waiting evidence while using TriggerFlow pause/resume.',
                           ...
                           'agent_task_loop_contract': 'AgentTaskLoop bounded execution steps run through '
                                                       ...
                                                       'and finalization. Flat '
                                                       'scoped_retrieval.query_groups and TaskBoard '
                                                       'source_ref_policy.scoped_retrieval_policy share the same '
                                                       'work-unit retrieval contract: planner/control models may '
                                                       ...
                                                       'facts and injects compact model-hot evidence_ledger plus '
                                                       'compatibility scoped_retrieval_results into the downstream '
                                                       'bounded agent_step or TaskBoard card while '
                                                       'full SHA/byte/backend provenance stays in raw Workspace/Blocks '
                                                       'evidence. EvidenceEnvelope.evidence_items is the canonical '
                                                       'internal grounding ledger for Flat synthesis, TaskBoard '
                                                       'card/final synthesis, verifier prompts, and host guards; each '
                                                       'item preserves id, kind, status(ok|failed|empty), '
                                                       'body_state(full|bounded|truncated|ref_only), and provenance, '
                                                       'while failed/empty items support only unavailable or '
                                                       'missing-data claims and ref_only items support only '
                                                       'discovery/ref-pointer claims until readback evidence exists. '
                                                       'Workspace search_files '
                                                       'and Blocks '
                                                       'workspace_operation return factual '
                                                       'locator_ref/evidence_snippet records only with truncated '
                                                       'bounded-snippet facts, Workspace '
                                                       "search_files treats pattern='**' as recursive file search "
                                                       'under the scoped path and uses rg as a grep-style engine when '
                                                       'available, record collections belong in filters.collection, '
                                                       'exact record kinds may use filters.kind, singleton structural '
                                                       'filter lists are normalized to scalar values, and Workspace '
                                                       'search accepts structural id/path/scope/meta filters for '
                                                       'scoped retrieval. TaskBoard readback '
                                                       'cards can read both Action artifact_refs and trusted Workspace '
                                                       'file_refs through bounded cold readbacks; '
                                                       'framework-synthesized readback/continuation patches scope '
                                                       'readback to direct dependencies plus upstream evidence cards '
                                                       'and do not recursively synthesize another readback chain from '
                                                       'generated continuation cards. Independent verifier requests '
                                                       'are reserved for terminal acceptance, evidence/artifact '
                                                       'boundary audit, contradictions, high-risk review, or cases '
                                                       'where no downstream consumer remains; ordinary intermediate '
                                                       'Flat work units with non-empty remaining_work default to '
                                                       'deferring terminal verification so the next Flat iteration '
                                                       'consumes their evidence, ready_for_final_verification=false '
                                                       'may make the same intent explicit, explicit '
                                                       'ready_for_final_verification=true hands the result to '
                                                       'terminal/blocking/risk verification, and ordinary TaskBoard cards let downstream '
                                                       'consumer cards decide whether evidence is sufficient and '
                                                       'return structured continuation/readback intent when it is '
                                                       'not; blocked scoped-retrieval cards without explicit next '
                                                       'action synthesize expanded evidence and continuation cards '
                                                       'instead of relying on a terminal verifier to repair '
                                                       'intermediate evidence. Structured outputs may include '
                                                       'evidence_use claim bindings; deterministic host guards reject '
                                                       'invalid ids, failed/empty positive support, and ref_only '
                                                       'content support before verifier judgment without parsing or '
                                                       'rewriting prose. Failed terminal Flat verification '
                                                       'carries compact repair_context into the next Flat work unit '
                                                       'and Workspace artifact draft request when present, including '
                                                       'acceptance deltas, repair constraints, next-step '
                                                       'requirements, and exact evidence anchors without restoring '
                                                       'cold provenance to model-hot prompts. TaskDAG is no '
                                                       'longer an '
                                                       'AgentTaskLoop bounded-step strategy; model-proposed '
                                                       ...
                                                       'blocks premature acceptance, and feeds the next AgentTaskLoop '
                                                       ...
                                                       'execution or through agent_task.progress.language. '
                                                       'get_async_generator(type="delta") is the public text-increment '
                                                       'stream and projects selected process events (template '
                                                       'progress, snapshots, heartbeats, phases, retry markers, and '
                                                       'terminal task results) into paragraph text; '
 ...
 'request_input': {'agent_execution_request_scope': {'status': 'released',
                                                     ...
                                                     'compatibility_policy': 'Expression-local chaining is the '
                                                                             ...
                                                                             'ModelRequest use.'},
                   'response_stream_type_surface': {'status': 'released',
                   ...
                   'agent_execution_task_loop': {'status': 'released',
                                                 ...
                                                 'contract': 'The 4.1.3.7 task-loop contract remains the published '
                                                             ...
                                                             'AgentExecution drafts, not a separate recommended '
                                                             'AgentTask execution owner. The second goal argument is '
                                                             'the current success-criteria entrypoint; separate '
                                                             'success_criteria(...) and success_standards(...) '
                                                             ...
                                                             'returns factual locator_ref/evidence_snippet records with '
                                                             'truncated bounded-snippet facts, and model-hot retrieval, '
                                                             'available-readback, Action-artifact-readback, '
                                                             'Workspace-readback, and verifier artifact-ref views are '
                                                             'derived from the canonical EvidenceEnvelope.evidence_items '
                                                             'ledger while omitting reconstructable SHA/bytes/backend '
                                                             'provenance; raw Workspace/Blocks evidence keeps audit '
                                                             'metadata. Evidence items preserve id, kind, '
                                                             'status(ok|failed|empty), '
                                                             'body_state(full|bounded|truncated|ref_only), and '
                                                             'provenance; failed/empty items support unavailable or '
                                                             'missing-data claims only, ref_only items support '
                                                             'discovery/ref-pointer claims only, and structured '
                                                             'evidence_use bindings let deterministic guards reject '
                                                             'invalid ids or impossible support before model '
                                                             'verification. TaskBoard blocked '
                                                             'scoped-retrieval cards without explicit next action '
                                                             'synthesize expanded evidence and continuation cards so '
                                                             'downstream consumers, not terminal-only verifiers, decide '
                                                             'whether intermediate evidence is now enough. Failed '
                                                             'terminal Flat verification carries compact repair_context '
                                                             'into the next Flat work unit and Workspace artifact draft '
                                                             'request when present, including acceptance deltas, repair '
                                                             'constraints, next-step requirements, and exact evidence '
                                                             'anchors without restoring cold provenance to model-hot '
                                                             'prompts. TaskDAG is no '
                                                             'longer an AgentTaskLoop bounded-step strategy; if a '
                                                             'planner or legacy config proposes '
                                                             'dynamic_task/execution_dag or effort '
                                                             "execution.step_plan='dag', AgentTaskLoop degrades the "
                                                             ...
                                                             'progress, snapshots, heartbeats, phases, retry markers, '
                                                             'and terminal task results; '
                                                             'get_async_generator(type="instant") returns structured '
                                                             'stream items. Workspace artifact deliveries are '
                                                             'verifier-visible only after trusted Workspace readback '
                                                             'with path, bytes, sha256, bounded preview, and '
                                                             'file_refs; capability_evidence.artifacts.readback '
                                                             'carries trusted readback path handles, not path#sha '
                                                             'ids, and '
                                                             ...
                                                             'max_iterations can return accepted=false and '
                                                             'artifact_status=partial. The task strategy writes '
                                                             'Workspace checkpoints through the checkpoint-store port '
                                                             'and records task evidence relationships with Workspace '
                                                             'evidence links. agent.resume(task_id) and '
                                                             'agent.async_resume(task_id) rebuild resumable '
                                                             'AgentTaskLoop snapshots as task-strategy AgentExecution '
                                                             'drafts; AgentExecutionResult resume delegates to the '
                                                             'same Agent facade when task_refs carry a resumable task '
                                                             'id. Agent.resume_task and Agent.async_resume_task are '
                                                 ...
                                                 'scope': {'current_slice': ['one Agent-owned business task',
                                                                             ...
                                                                             'Skill packs as AgentTaskLoop step '
                                                                             'capabilities',
