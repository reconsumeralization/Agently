 ...
 'companions': {'devtools': {'companion_package': 'agently-devtools',
                ...
                'blocks': {'lifecycle_contract': 'Blocks is the internal lowering bridge from AgentTaskLoop '
                           ...
                           'agent_task_loop_contract': 'AgentTaskLoop bounded execution steps run through '
                                                       ...
                                                       'Flat work units may return '
                                                       'ready_for_final_verification=false with remaining_work so the '
                                                       'next Flat iteration consumes their evidence instead of '
                                                       'triggering an immediate verifier, and ordinary TaskBoard cards let downstream '
