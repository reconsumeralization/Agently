...
_CURRENT_RELEASE_MANIFEST: dict[str, Any] = {'schema_version': 1,
 ...
 'notes': 'Version-scoped companion compatibility manifest for Agently 4.1.4.8: committed DeepSeek examples '
          'standardize their fallback on deepseek-v4-flash with thinking explicitly disabled, while environment '
          'overrides and intentional thinking-stream demonstrations remain supported; explicit model keys fail before '
          'provider dispatch when a configured non-empty model_pool does not contain the alias, while pool-free '
          'single-model inheritance remains compatible; resolve_model_profile provides a non-secret read-only '
          'preflight. It carries forward the 4.1.4.7 contract requiring Agently-Stage >=0.3.8,<0.4.0. Stage 0.3.7 '
          'supplies physically safe carrier routing across mixed sync/async boundaries and excludes every upstream '
          'carrier in a transitive synchronous wait chain; 0.3.8 preserves that contract while forwarding Python 3.14 '
          'task-factory keyword arguments. A synchronous TriggerFlow chunk may call a provider-owned sync wrapper that '
          "uses with Stage() for an async tool and may then re-enter TriggerFlow's synchronous state facade without "
          'knowing that the framework already uses Stage. The deprecated syncify/asyncify adapters retain their '
          'compatibility names and warnings but now delegate to Stage.as_sync/as_async; internal lightweight '
          'default_stage_call_bridge usage remains unchanged. Stage is the required-runtime companion and remains a '
          'private Agently mechanism dependency: TriggerFlowExecution remains the semantic lifecycle owner, and Stage '
          'types or carrier state do not enter public execution state. Built-in inactive gvisor, seatbelt, and '
          'landlock candidates use the existing provider-neutral code_execution contract and probe external mechanisms '
          'only when explicitly selected; they add no third-party Python dependency and fail closed without implicit '
          'fallback. Provider reasoning and explicit reasoning-token usage remain observation-only facts, and '
                ...
                'skills': {'repository': 'Agently-Skills',
                           ...
                           'runtime_contract': {'installed_truth_owner': 'SkillLibrary immutable content-addressed '
                                                ...
                                                'execution_scope_contract': 'Agent defaults plus current '
                                                                            ...
                                                                            'one frozen exact-revision scope; empty '
                                                                            'declarations do not expose the global '
                                                                            'SkillLibrary; unchanged preparation is '
                                                                            'idempotent',
                                                ...
                                                'execution_policy': 'No Skills route, Skill-local strategy, stage '
                                                                    ...
                                                                    'inference, or capability mounting; '
                                                                    'actionize_scripts compatibility projection '
                                                                    'returns inert binding_required candidates only; '
                                                                    'trusted exact-revision scripts require explicit '
                                                                    'host authorization and bind as ordinary '
                ...
                'action_runtime': {'task_workspace_contract': 'TaskWorkspace Actions own bounded file '
                                   ...
                                   'programmatic_action_calling': {'surface': ['Agent.set_action_loop(planning_protocol=programmatic)',
                                                                   ...
                                                                   'observation_contract': 'Program source, streamed '
                                                                                           ...
                                                                                           'artifacts; additive nested '
                                                                                           'Action lineage remains '
 ...
 'request_input': {'agent_execution_terminal_policies_and_patterns': {'surface': ['Agent.interact',
                                                                                  'Agent.review',
                                                                                  'Agent.verify',
                                                                                  'Agent.artifact',
                                                                                  'Agent.pattern',
                                                                      ...
                                                                      'pattern_stability': 'beta',
                                                                      'pattern_compatibility_contract': 'Pattern is an '
                                                                                                        'explicit '
                                                                                                        'opt-in beta '
                                                                                                        'surface. '
                                                                                                        'Registering '
                                                                                                        ...
                                                                                                        'failure '
                                                                                                        'semantics.',
                                                                      'contract': 'The additive AgentExecution draft '
                                                                                  'declarations keep one '
                                                                                  'business-result and lifecycle '
                                                                                  'owner. interact binds an '
                                                                                  'execution-local connected response '
                                                                                  'mechanism only when a real '
                                                                                  'ExecutionExchange opens; review is '
                                                                                  'one advisory handler or structured '
                                                                                  'ModelRequest judgment; verify uses '
                                                                                  'the same handler boundary as a hard '
                                                                                  'terminal gate without hiding a '
                                                                                  'repair loop. artifact renders the '
                                                                                  'accepted result to text or bytes '
                                                                                  'while TaskWorkspace retains '
                                                                                  'containment, write, physical digest '
                                                                                  'readback, trusted identity, and '
                                                                                  'terminal-retention authority. '
                                                                                  'pattern selects one whole-request '
                                                                                  'behavior that consumes the existing '
                                                                                  'AgentExecution '
                                                                                  'input/output/capability/policy '
                                                                                  'draft and returns its business '
                                                                                  'value; the registered AgentPattern '
                                                                                  'seam receives execution plus '
                                                                                  'one-use run_default, while complex '
                                                                                  'branching, loops, HITL wait/resume, '
                                                                                  'and recovery remain TriggerFlow and '
                                                                                  'ExecutionExchange concerns. '
                                                                                  'Ordinary requests implicitly use '
                                                                                  'request, and Agent.goal explicitly '
                                                                                  'selects the built-in goal Pattern '
                                                                                  'while preserving the existing '
                                                                                  'AgentTask implementation. The '
                                                                                  'default plugin registry also '
                                                                                  'distributes plan and long_content '
                                                                                  'through '
                                                                                  'agently.builtins.plugins.AgentPattern: '
                                                                                  'plan performs structured readiness, '
                                                                                  'connected ExecutionExchange '
                                                                                  'clarification, and terminal plan '
                                                                                  'generation while preserving the '
                                                                                  'caller output contract; '
                                                                                  'long_content validates an ordered '
                                                                                  'section plan, writes each section '
                                                                                  'sequentially with bounded '
                                                                                  'continuity, and host-assembles text '
                                                                                  'without a final model recopy. Both '
                                                                                  'bundled multi-request Patterns '
                                                                                  'reject ensure_long_output mixing '
                                                                                  'before model dispatch; long_content '
                                                                                  'also rejects structured output, and '
                                                                                  'disconnected plan clarification '
                                                                                  'fails closed until AgentExecution '
                                                                                  'can return a resumable Pattern '
                                                                                  'handle.',
                                                                      'typing_contract': 'Ordinary Agent and '
                                                                                         'AgentExecution fluent calls '
                                                                                         'require no type imports and '
                                                                                         'retain AgentExecution '
                                                                                         'through configuration. '
                                                                                         'Pattern, effort, and '
                                                                                         'strategy overloads expose '
                                                                                         'built-in Literal candidates '
                                                                                         'while plugin-extensible '
                                                                                         'Pattern names and '
                                                                                         'alternate-orchestrator '
                                                                                         'strategy names remain open '
                                                                                         'strings. AgentTask execution '
                                                                                         'is a host-validated finite '
                                                                                         'Literal set. '
                                                                                         'ExecutionExchangeView '
                                                                                         'guarantees the standard '
                                                                                         'interaction-handler fields; '
                                                                                         'interaction/review/artifact '
                                                                                         'handler types and the '
                                                                                         'minimal direct AgentPattern '
                                                                                         'protocol are available only '
                                                                                         'from their narrow '
                                                                                         'agently.types owner '
                                                                                         'namespaces.'},
