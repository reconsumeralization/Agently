 ...
 'request_input': {'agent_execution_request_scope': {'status': 'released',
                   ...
                   'agent_execution_task_loop': {'status': 'released',
                                                 ...
                                                 'contract': 'The 4.1.3.7 task-loop contract remains the published '
                                                             ...
                                                             'facade. Workspace artifact deliveries are '
                                                             'verifier-visible only after trusted Workspace '
                                                             'readback with path, bytes, sha256, bounded preview, '
                                                             'and file_refs; capability_evidence.artifacts.readback '
                                                             ...
                                                             'instead of budget or iteration shortfall. '
                                                             'Completion acceptance requires model-owned '
