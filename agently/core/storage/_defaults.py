...
def default_record_store_root() -> Path:
    """Return the default root containing Agently-private record state."""
...
def script_scope(settings: Any = None) -> str:
    ...
    configured = _settings_get(settings, "record_store.script_scope")
...
__all__ = ["default_record_store_root", "merge_scope", "script_scope"]
