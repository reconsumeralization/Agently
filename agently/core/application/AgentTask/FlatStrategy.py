...
class AgentTaskFlatStrategyMixin(AgentTaskMixinBase):
    ...
    async def _request_plan(self, iteration_index: int, context_pack: "WorkspaceContextPackage") -> dict[str, Any]:
        ...
        request.instruct(
            ...
            "explicit retrieval tuning, query groups may include tags, method='keyword'|'vector'|'hybrid', "
            "rerank, selection='length'|'top_n', top_n, or max_candidates; omit these unless the task gives a concrete "
