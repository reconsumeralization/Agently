---
name: pinned-release-checklist
description: Minimal guidance-only Skill used by release-pinned compatibility examples.
---

# Pinned Release Checklist

Use this Skill when a release check needs a deterministic guidance-only Skill
