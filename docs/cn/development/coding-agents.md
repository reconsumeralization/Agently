...
对 Agently `4.1.2.2`，把 `examples/cookbook/`、`examples/action_runtime/`、`examples/execution_environment/`、`examples/builtin_actions/`、`examples/trigger_flow/` 和 `examples/fastapi/` 视为推荐起点；`examples/archived/` 只作为兼容参考。
