...
For Agently `4.1.2.3`, treat `examples/cookbook/`, `examples/action_runtime/`, `examples/execution_environment/`, `examples/builtin_actions/`, `examples/trigger_flow/`, `examples/dynamic_task/`, and `examples/fastapi/` as the recommended starting surfaces. Treat `examples/archived/` as compatibility reference only.
