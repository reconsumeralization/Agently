...
| Vector retrieval | `LocalVectorIndex` adds provider-neutral vector scoring with cosine, dot, and L2 similarity options. | Keep embedding providers in application code or custom backends and pass vector indexes through Workspace seams. |
