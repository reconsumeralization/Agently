...
Agently 4.1.3 是 4.1.2 运行时基础正式连成 AI 应用运行时的一版。一次 Agent turn
现在可以把模型推理、Actions、远程 Skills、MCP 工具、Dynamic Task DAG、过程流、
结构化输出和 coding-agent 指引放进同一条工程路径里。完整版本叙事见
[4.1.3 Release Notes](docs/cn/development/release-notes-4.1.3.md)。
...
- 当前 package version 是 `4.1.3`。
- 当前 release manifest 是 `compatibility/releases/4.1.3.json`。
