...
[4.1.4.8 Release Notes](docs/en/development/release-notes-4.1.4.8.md),
...
Agently 4.1.4.8 recommends `agently-devtools >=0.1.11,<0.2.0`.
...
- The current package version is `4.1.4.8`.
- The current release manifest is `compatibility/releases/4.1.4.8.json`.
