...
Agently 4.1.4.7 pins mixed sync/async TriggerFlow integrations to
Agently-Stage 0.3.7+, including safe carrier routing across transitive
synchronous waits. Read the
...
Agently 4.1.4.7 recommends `agently-devtools >=0.1.10,<0.2.0`.
